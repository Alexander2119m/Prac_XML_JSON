...
const tituloSemestre = document.querySelector('#titulo-semestre');
	...
	selectSemestre.addEventListener('change', () => {
        ...
        function generarHorario() {
          ...
          // Aquí puedes agregar la lógica para generar el horario según las opciones seleccionadas
          // Puedes utilizar las variables "facultad", "carrera" y "semestre" para generar el horario deseado
  
          // Mostrar la tabla de horario una vez que se genera
          var horarioTable = document.getElementById("horarioTable");
          horarioTable.style.display = "table";
        }
